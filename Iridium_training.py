...
for _ in range(AdamW_scheduler.last_epoch + 1, max_epochs):
    ...
    if (AdamW_scheduler.last_epoch + 1) % config["GraphEveryEpochs"] == 0:
        ...
        axs[0].plot(training_log.index, training_log["Energy RMSE"], lw=3, label="Energy RMSE")
        axs[1].plot(training_log.index, training_log["Force RMSE"], lw=3, label="Force RMSE")
        axs[2].plot(training_log.index, training_log["Energy MSE"], lw=3, label="Energy MSE")
        axs[3].plot(training_log.index, training_log["Force MSE"], lw=3, label="Force MSE")
